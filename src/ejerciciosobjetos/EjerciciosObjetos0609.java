...
public class EjerciciosObjetos0609 {
    ...
    public static void main(String[] args) {
        ...
        while ( alta != 0 ){
            ...
            TelefonoPrepago movil = new TelefonoPrepago(nM, cEL, cML, cMB, saldo);
            ...
            do {
                ...
                switch (opcion){
                    ...
                    case 3:
                        ...
                        boolean recargar = movil.recargar(teclado.nextInt());
                        if (recargar) System.out.println("Despues de recargar tu saldo es de: " +movil.consultarSaldo()); 
